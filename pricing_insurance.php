		...
		<div class="row">
			<div class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6">
				...
				<ul>
					...
					<li>Anthem HealthKeepers, Inc.</li>
		...
		<div class="row">
			<div class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6">
				...
				<ul>
					...
					<li>
						<p>What is my deductible and how much have I met so far?</p>
					</li>
					<li>
						<p>Do I have a co-pay for physical therapy?</p>
					</li>
					<li>
						<p>How many physical therapy visits does my policy allow per calendar year?</p>
					</li>
					<li>
						<p>What portion/percentage of the bill will be my responsibility after insurance has paid?</p>
					</li>
				</ul>
			</div>
		</div>
